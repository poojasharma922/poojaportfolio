...
const About = () => {
  return (
    <section className="about container section" id="about">
      <h2 className="section__title" style={{textAlign: 'center'}}>About Me</h2>

      <div className="about__container grid">
        <img src={Image} alt="" className="about__img" style={{height: '200px',borderRadius: '10px', marginBottom: '20px'}} />
        ...
        <div className="about__data grid">
          <div className="about__info">
            ...
            A highly organized and hardworking student pursuing Bachelor's degree seeking a challenging position in a reputed organization where I can learn new skills, expand my knowledge, and leverage my learnings
              ...
              <Link to="https://drive.google.com/file/d/1KVtti1zQgElRtgXWfneCX_Nt8tI5PxkE/view?usp=sharing" target='blank' className="btn" >Get CV</Link>
